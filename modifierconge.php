...
$conge1 = NULL;
if (isset($_GET['id'])){
  $conge1 = $congec->getconge($_GET['id']);
  $date1 = date($conge1['date']);
  $duree = $conge1['duree']-1;
  $newDate = date('Y-m-d', strtotime($date1. " + {$duree} days"));
}
if ( isset($_POST['id_enseignant']) and isset($_POST['datedebut']) and isset($_POST['datefin']) ){
  ...
  $congec->modifierconges($conge,$_POST['id_conge']);
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              <div class=" form">
                <form class="cmxform form-horizontal style-form" id="commentForm" method="post" action="" autocomplete="off">
                  <div class="form-group ">
                    ...
                    <div class="col-lg-3">
                      <select class="btn btn-default dropdown-toggle" name="id_enseignant">
                        ...
                        {
                          $selected ="";
                          if ($enseignant['id']==$conge1['id_enseignant']){
                            $selected = "selected";
                          }
                          echo "<option ".$selected." value=".$enseignant['id'].">".$enseignant['nom']." ".$enseignant['prenom']."</option>";
                        }
                        ?>
                      </select>
                    </div>
                  ...
                  <label class="control-label col-lg-2">Date Range</label>
                    <div class="col-md-4">
                      <div class="input-group input-large" data-date="01/01/2014" data-date-format="mm/dd/yyyy">
                        <input type="text" class="form-control dpd1" name="datedebut" value="<?php echo $conge1['date'];?>">
                        <span class="input-group-addon">To</span>
                        <input type="text" class="form-control dpd2" name="datefin" value="<?php echo $newDate;?>">
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" value="<?PHP echo $_GET['id']; ?>" name="id_conge">
